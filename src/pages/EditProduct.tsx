            ...
            <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                <form onSubmit={handleSubmit(handleUpdateProduct)}>
                    <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div className="sm:col-span-2">
                            <label htmlFor="unidadeDeMedida" className="block mb-2 text-sm font-medium text-[#1C2434] dark:text-white">Unidade de medida</label>
                            <select 
                              id="unidadeDeMedida" 
                        ...
                        <div className="sm:col-span-2">
                            <label htmlFor="descricaoDoProduto" className="block mb-2 text-sm font-medium text-[#1C2434] dark:text-white">Descrição</label>
                            <textarea 
